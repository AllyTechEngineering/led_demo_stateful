...
class Constants {
  static const String kTitle = 'LED Demo';
  static const String kOn = 'PWM LED: Enabled';
  static const String kOff = 'PWM LED: Disabled';
  static const String kLabel = 'LED: ';
  static const String kStatusFalse = 'Sensor LED: Off';
  static const String kStatusTrue = 'Sensor LED: On';
